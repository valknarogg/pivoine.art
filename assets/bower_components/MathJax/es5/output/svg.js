!(function (t) {
			...
			h = (function (t) {
				...
				return (
					...
					(e.prototype.addChildren = function (t) {
						...
						try {
							for (
								var n = i(this.childNodes), s = n.next();
								!s.done;
								s = n.next()
							) {
								var a = s.value;
								a.toSVG(t),
									a.element && a.place(o + a.bbox.L * a.bbox.rscale, 0),
									(o += (a.bbox.L + a.bbox.w + a.bbox.R) * a.bbox.rscale);
							}
						} catch (t) {
							e = { error: t };
						} finally {
					...
					(e.prototype.handleAttributes = function () {
						...
						try {
							for (
								var h = i(s.getExplicitNames()), c = h.next();
								!c.done;
								c = h.next()
							) {
								var u = c.value;
								(!1 !== l[u] &&
									...
									this.adaptor.setAttribute(this.element, u, s.getExplicit(u));
							}
						} catch (e) {
							t = { error: e };
						} finally {
					...
					(e.prototype.place = function (t, e, r) {
						if ((void 0 === r && (r = null), t || e)) {
							...
							(o =
								...
								")" +
								(o ? " " + o : "")),
								this.adaptor.setAttribute(r, "transform", o);
						}
					}),
					(e.prototype.placeChar = function (t, e, r, o, n) {
						...
						var h = t.toString(16).toUpperCase(),
							c = s(this.getVariantChar(n, t), 4),
							u = c[2],
							p = c[3];
						if ("p" in p) {
							var d = p.p ? "M" + p.p + "Z" : "";
							this.place(e, r, this.adaptor.append(o, this.charNode(n, h, d)));
						} else if ("c" in p) {
							var f = this.adaptor.append(o, this.svg("g", { "data-c": h }));
							...
							var b = String.fromCodePoint(t),
								x = this.adaptor.append(o, this.jax.unknownText(b, n));
							return (
								this.place(e, r, x),
								this.jax.measureTextNodeWithCache(x, b, n).w
							);
						}
						return u;
					}),
	...
	function (t, e, r) {
		...
		var a = (function () {
			function t() {
				...
				try {
					for (
						var n = s(Object.keys(r.defaultChars)), a = n.next();
						!a.done;
						a = n.next()
					) {
						var l = a.value;
			...
			return (
									...
									if (c[f])
										try {
											for (
												...
												t[(b = _.value)] = this.smpChar(v + c[f][b]);
											}
										} catch (t) {
											i = { error: t };
										} finally {
				...
				(t.prototype.createVariants = function (t) {
					var e, r;
					try {
						for (var o = s(t), n = o.next(); !n.done; n = o.next()) {
							var i = n.value;
				...
				(t.prototype.defineChars = function (t, e) {
					...
					try {
						for (var i = s(n.linked), a = i.next(); !a.done; a = i.next()) {
							var l = a.value;
							Object.assign(l, e);
						}
					} catch (t) {
	...
	function (t, e, r) {
		...
		Object.defineProperty(e, "__esModule", { value: !0 }),
			...
			(e.CommonDiagonalArrow = function (t) {
				return function (r) {
					var n = o(e.diagonalArrowDef[r], 4),
						i = n[0],
						s = n[1],
						a = n[2];
					return [
						r + "arrow",
						{
							...
							bbox: function (t) {
								var e = t.arrowData(),
									...
									n = e.x,
									i = e.y,
									s = o([t.arrowhead.x, t.arrowhead.y, t.arrowhead.dx], 3),
									a = s[0],
									l = s[1],
									h = s[2],
									c = o(t.getArgMod(a + h, l), 2),
									u = c[0],
									p = c[1],
									d = i + (u > r ? t.thickness * p * Math.sin(u - r) : 0),
									f =
										n +
										(u > Math.PI / 2 - r
					...
					return (
						...
						(e.prototype.computeBBox = function (t, e) {
							...
							var r = this.baseChild.getBBox(),
								...
								n = this.supChild.getBBox();
							t.empty(), t.append(r);
							var s = t.w,
								a = i(this.getUVQ(r, o, n), 2),
								l = a[0],
								h = a[1],
						...
						(e.prototype.getUVQ = function (t, e, r) {
							...
							var o = this.font.params,
								...
								l = i([this.getU(t, r), Math.max(a, s)], 2),
								h = l[0],
								c = l[1],
						...
						(e.prototype.computeBBox = function (e, r) {
							if ((void 0 === r && (r = !1), this.hasMovableLimits()))
								...
								var o = this.baseChild.getBBox(),
									...
									s = this.getUnderKV(o, n)[1],
									a = this.getDelta(!0),
									l = i(this.getDeltaW([o, n], [0, -a]), 2),
									h = l[0],
									c = l[1];
								e.combine(o, h, 0),
									e.combine(n, c, s),
						...
						(e.prototype.computeBBox = function (e) {
							if (this.hasMovableLimits())
								...
								var r = this.baseChild.getBBox(),
									...
									n = this.getOverKU(r, o)[1],
									s = this.getDelta(),
									a = i(this.getDeltaW([r, o], [0, s]), 2),
									l = a[0],
									h = a[1];
								e.combine(r, l, 0),
									e.combine(o, h, n),
						...
						(e.prototype.computeBBox = function (e) {
							if (this.hasMovableLimits())
								...
								var r = this.overChild.getBBox(),
									...
									s = this.getOverKU(o, r)[1],
									a = this.getUnderKV(o, n)[1],
									l = this.getDelta(),
									h = i(this.getDeltaW([o, n, r], [0, -l, l]), 3),
									c = h[0],
									u = h[1],
									p = h[2];
								e.combine(o, c, 0), e.combine(r, p, s), e.combine(n, u, a);
	...
	function (t, e, r) {
		...
		var s = r(57),
			...
			u = (function (t) {
				...
				return n(e, t), (e.kind = c.MmlMsub.prototype.kind), (e.useIC = !1), e;
			})(a.CommonMsubMixin(s.SVGscriptbase));
		e.SVGmsub = u;
		var p = (function (t) {
			function e() {
				return (null !== t && t.apply(this, arguments)) || this;
			}
			return n(e, t), (e.kind = c.MmlMsup.prototype.kind), (e.useIC = !0), e;
		})(l.CommonMsupMixin(s.SVGscriptbase));
		e.SVGmsup = p;
		var d = (function (t) {
			function e() {
				return (null !== t && t.apply(this, arguments)) || this;
			...
			return (
				...
				(e.prototype.toSVG = function (t) {
					var e = this.standardSVGnode(t),
						...
						s = r[2],
						a = o.getBBox(),
						l = i(this.getUVQ(a, s.getBBox(), n.getBBox()), 2),
						h = l[0],
						c = l[1],
					...
					o.toSVG(e),
						n.toSVG(e),
						s.toSVG(e),
						s.place(a.w * a.rscale, c),
						n.place(a.w * a.rscale + u, h);
				}),
				(e.kind = c.MmlMsubsup.prototype.kind),
				(e.useIC = !1),
				e
			);
		})(h.CommonMsubsupMixin(s.SVGscriptbase));
		e.SVGmsubsup = d;
	},
	function (t, e, r) {
		"use strict";
		...
		var d = (function (t) {
			function r(e) {
				void 0 === e && (e = null);
				var r = t.call(this, e, l.SVGWrapperFactory, h.TeXFont) || this;
				return (
					(r.minwidth = 0),
					(r.shift = 0),
					(r.container = null),
					(r.svgStyles = null),
					(r.fontCache = new c.FontCache(r)),
					r
				);
			}
			return (
				...
				(r.prototype.setScale = function (t) {
					1 !== this.options.scale &&
						this.adaptor.setStyle(t, "fontSize", p.percent(this.options.scale));
				}),
				...
				(r.prototype.processMath = function (t, e) {
					...
					var o = this.factory.wrap(t),
						n = s(this.createRoot(o), 2),
						i = n[0],
						a = n[1];
					this.typesetSVG(o, i, a), (this.container = r);
				}),
				(r.prototype.createRoot = function (t) {
					...
					if (
						(0.001 === a &&
							(h.setAttribute(c, "preserveAspectRatio", "xMidYMid slice"),
							o < 0 && h.setStyle(this.container, "margin-right", this.ex(o))),
						s)
					) {
						h.setStyle(c, "min-width", this.ex(a)),
							h.setAttribute(c, "width", s),
							h.removeAttribute(c, "viewBox");
						var u = t.metrics.ex / (1e3 * this.font.params.x_height);
						h.setAttribute(
							l,
							"transform",
							"matrix(1 0 0 -1 0 0) scale(" +
								this.fixed(u, 6) +
								") translate(0, " +
								this.fixed(1e3 * -n, 1) +
								")",
					...
					return (
						"none" !== this.options.fontCache &&
							h.setAttribute(c, "xmlns:xlink", e.XLINKNS),
						[c, l]
					);
				}),
				...
				(r.prototype.unknownText = function (t, e) {
					var r = this.math.metrics,
						...
						i = this.adaptor;
					if ("-explicitFont" !== e) {
						var a = u.unicodeChars(t);
						if (1 !== a.length || a[0] < 119808 || a[0] > 120831) {
							var l = s(this.font.getCssFont(e), 3),
								h = l[0],
								c = l[1],
								p = l[2];
							i.setAttribute(n, "font-family", h),
								c && i.setAttribute(n, "font-style", "italic"),
				...
				(r.NAME = "SVG"),
				(r.OPTIONS = i(i({}, a.CommonOutputJax.OPTIONS), {
				...
				return (function (t) {
					function r() {
						...
						var o = t.apply(this, s(e)) || this,
							...
							a = o.node.attributes.get("actiontype"),
							l = i(n.get(a) || [function (t, e) {}, {}], 2),
							h = l[0],
							c = l[1];
			...
			return (function (t) {
				function e() {
					for (var e, r, o = [], n = 0; n < arguments.length; n++)
						o[n] = arguments[n];
					var i = t.apply(this, s(o)) || this;
					i.stretchChildren();
					try {
						for (var h = a(i.childNodes), c = h.next(); !c.done; c = h.next()) {
							var u = c.value;
							if (u.bbox.pwidth) {
					...
					(e.prototype.stretchChildren = function () {
						...
						try {
							for (
								...
								(S = h.value).canStretch(1) && s.push(S);
							}
						} catch (e) {
							t = { error: e };
						} finally {
						...
						if (c && u > 1) {
							...
							try {
								for (var _ = a(s), M = _.next(); !M.done; M = _.next()) {
									var S;
									(S = M.value).coreMO().getStretchedVariant([p, d]);
								}
							} catch (t) {
								n = { error: t };
							} finally {
							...
							if (p && d > 1) {
								if (null === t) {
									var f = 0,
										...
										m = p > 1 && p === d;
									try {
										for (var v = i(h), b = v.next(); !b.done; b = v.next()) {
											var x = 0 === (O = b.value.childNodes[0]).stretch.dir;
											if (m || x) {
												var g = O.getBBox(x),
													_ = g.h,
													M = g.d;
								...
								try {
									for (var S = i(l), w = S.next(); !w.done; w = S.next()) {
										var O;
										(O = w.value).coreMO().getStretchedVariant(t);
									}
								} catch (t) {
									s = { error: t };
								} finally {
				...
				return (
					...
					(e.prototype.toSVG = function (t) {
						var e = this.childNodes[this.surd],
							...
							u = this.adaptor.append(c, this.svg("g"));
						this.addRoot(c, o, i, h),
							e.toSVG(c),
					...
					(e.kind = a.MmlMsqrt.prototype.kind),
					e
				);
			})(s.CommonMsqrtMixin(i.SVGWrapper));
		e.SVGmsqrt = l;
	},
	function (t, e, r) {
		"use strict";
	...
	function (t, e, r) {
		...
		(e.SVGFontData = h),
			(e.AddPaths = function (t, e, r) {
				var o, n, i, s;
				try {
					for (var l = a(Object.keys(e)), c = l.next(); !c.done; c = l.next()) {
						var u = c.value,
							p = parseInt(u);
				...
				try {
					for (var d = a(Object.keys(r)), f = d.next(); !f.done; f = d.next()) {
			...
			f = (function (t) {
				function e(e, r, o) {
					void 0 === e && (e = null),
						...
						void 0 === o && (o = null);
					var n = this,
						i = s(c.separateOptions(e, o.OPTIONS), 2),
						a = i[0],
						l = i[1];
					return (
						((n = t.call(this, a) || this).factory =
				...
				return (
					...
					(e.prototype.getMetricMaps = function (t) {
						...
						var x =
							...
							g = [new Map(), new Map()];
						try {
							for (var _ = a(g.keys()), M = _.next(); !M.done; M = _.next()) {
								var S = M.value;
								try {
									for (
										var w = ((i = void 0), a(f[S].keys())), O = w.next();
										!O.done;
										O = w.next()
									) {
										var C = O.value;
										g[S].set(C, this.measureMetrics(f[S].get(C), x));
									}
								} catch (t) {
									i = { error: t };
								} finally {
						...
						try {
							for (var B = a(g.keys()), j = B.next(); !j.done; j = B.next()) {
								S = j.value;
								try {
									for (
										var P = ((u = void 0), a(f[S].values())), V = P.next();
										!V.done;
										V = P.next()
									) {
										C = V.value;
					...
					(e.prototype.styleSheet = function (t) {
						...
						try {
							for (
								var h = a(this.factory.getKinds()), c = h.next();
								!c.done;
								c = h.next()
							) {
								var u = c.value;
			...
			return (
				...
				(e.prototype.getScale = function () {
					...
					if (0 !== n) {
						...
						var a = this.length2em(o.get("scriptminsize"), 0.8, 1);
						t < a && (t = a);
					}
					this.removedStyles &&
					...
					if (this.node.isToken)
						try {
							for (
								...
								var s = n.value;
								s instanceof h.TextNode && (r += s.getText());
							}
						} catch (e) {
							t = { error: e };
						} finally {
				...
				return (function (t) {
					...
					return (
						...
						(e.prototype.computeBBox = function (t, e) {
							var r, o;
							void 0 === e && (e = !1);
							var n = this.parent.variant,
								a = this.node.getText();
							if ("-explicitFont" === n) {
								var l = this.jax.getFontData(this.parent.styles),
									h = this.jax.measureText(a, n, l),
									c = h.w,
									u = h.h,
									p = h.d;
								(t.h = u), (t.d = p), (t.w = c);
							} else {
								var d = this.remappedText(a, n);
								t.empty();
								try {
									for (var f = i(d), y = f.next(); !y.done; y = f.next()) {
										var m = y.value,
											v = s(this.getVariantChar(n, m), 4),
											b = ((u = v[0]), (p = v[1]), (c = v[2]), v[3]);
										if (b.unknown) {
											var x = this.jax.measureText(String.fromCodePoint(m), n);
											(c = x.w), (u = x.h), (p = x.d);
										}
										(t.w += c),
											u > t.h && (t.h = u),
			...
			return (function (t) {
				...
				return (
					...
					(e.prototype.getParameters = function () {
						...
						if (void 0 !== o) {
							var n = i(h.split(o), 3),
								...
								c = n[2];
							this.arrowhead = {
								x: s ? parseFloat(s) : l.ARROWX,
								y: a ? parseFloat(a) : l.ARROWY,
					...
					(e.prototype.getNotations = function () {
						...
						try {
							for (
								var o = a(h.split(this.node.attributes.get("notation"))),
									n = o.next();
								!n.done;
								n = o.next()
							) {
					...
					(e.prototype.removeRedundantNotations = function () {
						...
						try {
							for (
								var n = a(Object.keys(this.notations)), i = n.next();
								!i.done;
								i = n.next()
							) {
								var s = i.value;
								if (this.notations[s]) {
									var l = this.notations[s].remove || "";
									try {
										for (
											var h = ((r = void 0), a(l.split(/ /))), c = h.next();
											!c.done;
											c = h.next()
										) {
											var u = c.value;
					...
					(e.prototype.initializeNotations = function () {
						...
						try {
							for (
								var r = a(Object.keys(this.notations)), o = r.next();
								!o.done;
								o = r.next()
							) {
								var n = o.value,
					...
					(e.prototype.getBBoxExtenders = function () {
						...
						try {
							for (
								var o = a(Object.keys(this.notations)), n = o.next();
								!n.done;
								n = o.next()
							) {
								var i = n.value;
					...
					(e.prototype.arrowData = function () {
						var t = i([this.padding, this.thickness], 2),
							...
							c = Math.max(e, (r * a) / h),
							u = Math.max(e, (r * l) / h),
							p = i(this.getArgMod(a + 2 * c, l + 2 * u), 2);
				...
				return (function (t) {
					function e() {
						...
						if (
							...
							var n = o.getBevelData(o.isDisplay()).H,
								i = (o.bevel = o.createMo("/"));
					...
					return (
						...
						(e.prototype.computeBBox = function (t, e) {
							...
							if (n) this.getBevelledBBox(t, i);
								...
								var a = this.length2em(String(o), 0.06);
								(s = -2 * this.pad),
									0 === a
						...
						(e.prototype.getFractionBBox = function (t, e, r) {
							var o = this.childNodes[0].getBBox(),
								...
								l = s.u,
								h = s.v;
							t.combine(o, 0, i + a + Math.max(o.d * o.rscale, l)),
								t.combine(n, 0, i - a - Math.max(n.h * n.rscale, h)),
								(t.w += 2 * this.pad + 0.2);
						}),
						...
						(e.prototype.getAtopBBox = function (t, e) {
							var r = this.getUVQ(e),
								...
								i = r.nbox,
								s = r.dbox;
							t.combine(i, 0, o), t.combine(s, 0, -n), (t.w += 2 * this.pad);
						}),
						(e.prototype.getUVQ = function (t) {
							var e = this.childNodes[0].getBBox(),
								r = this.childNodes[1].getBBox(),
								o = this.font.params,
								n = i(t ? [o.num1, o.denom1] : [o.num3, o.denom2], 2),
								s = n[0],
								a = n[1],
								l = (t ? 7 : 3) * o.rule_thickness,
								h = s - e.d * e.scale - (r.h * r.scale - a);
							return (
								h < l && ((s += (l - h) / 2), (a += (l - h) / 2), (h = l)),
								{ u: s, v: a, q: h, nbox: e, dbox: r }
							);
						}),
					...
					return (
						...
						(r.prototype.computeBBox = function (t, e) {
							...
							var r = this.font.params.scriptspace,
								...
								s = this.combinePrePost(o.sup, o.psup),
								a = i(this.getUVQ(o.base, n, s), 2),
								l = a[0],
								h = a[1];
							if (
								(t.empty(),
						...
						(r.prototype.combineBBoxLists = function (t, e, r, o) {
							for (var n = 0; n < r.length; n++) {
								var s = i(this.getScaledWHD(r[n]), 3),
									a = s[0],
									l = s[1],
									h = s[2],
					...
					return (
						...
						(e.prototype.computeBBox = function (e, r) {
							...
							if (
								...
								var n = (e.h + e.d) / 2 + this.font.params.axis_height - e.h;
								(e.h += n), (e.d -= n);
							}
						}),
						(e.prototype.getVariant = function () {
							...
							if ((void 0 === e && (e = !1), 0 !== this.stretch.dir)) {
								...
								var a =
										i || e
											? n
											: Math.max(
													(n * this.font.params.delimiterfactor) / 1e3,
													n - this.font.params.delimitershortfall,
												),
									h = this.stretch,
						...
						(e.prototype.getStretchBBox = function (t, e, r) {
							...
							var n = s(r.HDW, 3),
								...
								l = n[2];
							1 === this.stretch.dir
								? ((i = (o = s(this.getBaseline(t, e, r), 2))[0]), (a = o[1]))
								: (l = e),
								(this.bbox.h = i),
								(this.bbox.d = a),
								(this.bbox.w = l);
					...
					return (
						...
						(e.prototype.getRootDimens = function (t, e) {
							var r = this.childNodes[this.surd],
								...
								a = Math.max(i, n / s),
								l = Math.max(0, a - i);
							return [a * s - n, this.rootHeight(o, t, r.size, e), l];
						}),
						(e.prototype.rootHeight = function (t, e, r, o) {
							var n = e.h + e.d;
							return (
								(r < 0 ? 1.9 : 0.55 * n) - (n - o) + Math.max(0, t.d * t.rscale)
							);
						}),
						e
					);
				...
				return (function (t) {
					function e() {
						...
						return (
							...
							o.childNodes.unshift(o.createText(i.lquote)),
							o.childNodes.push(o.createText(i.rquote)),
							o
						);
					}
					return (
			...
			return (function (t) {
				function e() {
					...
					var o = t.apply(this, s(e)) || this,
						n = o.createMo("\u221a");
					n.canStretch(1);
					var i = o.childNodes[o.base].getBBox(),
						a = i.h,
						l = i.d,
					...
					return (
						(o.surdH = a + l + 2 * h + c / 4),
						n.getStretchedVariant([o.surdH - l, l], !0),
						o
					);
				}
				return (
					...
					(e.prototype.computeBBox = function (t, e) {
						...
						var r = this.childNodes[this.surd].getBBox(),
							o = new a.BBox(this.childNodes[this.base].getBBox()),
							n = this.getPQ(r)[1],
				...
				return (
					...
					(e.prototype.stretchRows = function () {
						for (
							...
							var a = t ? [(e + o[s] - n[s]) / 2, (e - o[s] + n[s]) / 2] : null;
					...
					(e.prototype.stretchColumn = function (t, e) {
						...
						if (p && d > 1) {
								...
								try {
									for (
										...
										if ((v = m.value.getChild(t))) {
											var b = 0 === (M = v.childNodes[0]).stretch.dir;
											if (f || b) {
												var x = M.getBBox(b).w;
												x > e && (e = x);
											}
							...
							try {
								for (var g = a(h), _ = g.next(); !_.done; _ = g.next()) {
									var M;
					...
					(e.prototype.getTableData = function () {
						...
						for (
							...
							(o[a] = t[a]),
								(n[a] = e[a]),
								l.labeled && this.updateHDW(l.childNodes[0], 0, a, t, e, i);
						}
						var u = i[0];
						return (
							(this.data = { H: t, D: e, W: r, NH: o, ND: n, L: u }), this.data
						);
					}),
					(e.prototype.updateHDW = function (t, e, r, o, n, i) {
						void 0 === i && (i = null);
						var s = t.getBBox(),
							a = s.h,
							l = s.d,
					...
					(e.prototype.computeBBox = function (t, e) {
						...
						} else r = c.sum(s.concat(a, this.rLines, this.rSpace));
					...
					(e.prototype.setChildPWidths = function (t, e, r) {
						...
						var n = this.bbox,
							...
							s = n.L,
							a = n.R,
							l = Math.max(i, this.length2em(o, Math.max(e, s + i + a))),
					...
					(e.prototype.setColumnPWidths = function () {
						...
						try {
							for (
								var o = a(this.pwidthCells), n = o.next();
								!n.done;
								n = o.next()
							) {
								var s = i(n.value, 2),
					...
					(e.prototype.getBBoxHD = function (t) {
						...
						var a = this.getVerticalPosition(o, r);
						return [a, t - a];
					}),
					...
					(e.prototype.getColumnWidthsFixed = function (t, e) {
						...
						o.forEach(function (o) {
							var n = t[o];
							h -= "fit" === n || "auto" === n ? a[o] : r.length2em(n, e);
						});
						var u = s && h > 0 ? h / s : 0;
					...
					(e.prototype.getVerticalPosition = function (t, e) {
						for (
							...
							h += l[c] + (r ? a : n[c] + s[c]) + l[c + 1] + this.rLines[c];
						var u = i(
								r
									? [(a + n[t] - s[t]) / 2, (a - n[t] + s[t]) / 2]
									: [n[t], s[t]],
								2,
							),
							p = u[0],
				...
				((e = (function (t) {
					function e() {
						...
						for (
							...
							if (!(n = n.childNodes[0])) return o;
						return "noIC" in n
							? ((o.baseCore = n), o.constructor.useIC || (n.noIC = !0), o)
							: o;
					}
					return (
						n(e, t),
						...
						(e.prototype.getDeltaW = function (t, e) {
							...
							var l = this.node.attributes.get("align"),
								...
								c = Math.max.apply(Math, s(h)),
								u = [],
								p = 0;
							try {
								for (var d = a(h.keys()), f = d.next(); !f.done; f = d.next()) {
									(u[(v = f.value)] =
										("center" === l
											? (c - h[v]) / 2
											: "right" === l
						...
						(e.prototype.stretchChildren = function () {
							...
							try {
								for (
									...
									(M = h.value).canStretch(2) && s.push(M);
								}
							} catch (e) {
								t = { error: e };
							} finally {
							...
							if (c && u > 1) {
								...
								try {
									for (var g = a(s), _ = g.next(); !_.done; _ = g.next()) {
										var M;
										(M = _.value)
											.coreMO()
	...
	function (t, e, r) {
		...
		var i = r(19),
			...
			a = (function (t) {
				...
				return n(e, t), (e.defaultNodes = s.SVGWrappers), e;
			})(i.CommonWrapperFactory);
		e.SVGWrapperFactory = a;
	},
	function (t, e, r) {
		"use strict";
		var o;
		...
		e.SVGWrappers =
			...
			(o[s.SVGmrow.kind] = s.SVGmrow),
			(o[s.SVGinferredMrow.kind] = s.SVGinferredMrow),
			(o[a.SVGmi.kind] = a.SVGmi),
			(o[l.SVGmo.kind] = l.SVGmo),
			(o[h.SVGmn.kind] = h.SVGmn),
			(o[c.SVGms.kind] = c.SVGms),
			...
			(o[b.SVGmroot.kind] = b.SVGmroot),
			(o[x.SVGmfenced.kind] = x.SVGmfenced),
			(o[g.SVGmsub.kind] = g.SVGmsub),
			(o[g.SVGmsup.kind] = g.SVGmsup),
			(o[g.SVGmsubsup.kind] = g.SVGmsubsup),
			...
			(o[S.SVGmtable.kind] = S.SVGmtable),
			(o[w.SVGmtr.kind] = w.SVGmtr),
			(o[w.SVGmlabeledtr.kind] = w.SVGmlabeledtr),
		...
		var a = r(0),
			...
			u = (function (t) {
				...
				return (
						...
						if (
							...
							if (
								...
								"right" === e
									...
									: "left" === e
										? (n = Math.max(n || r, r))
										: "center" === e && (s += 2 * Math.abs(r)),
									(this.jax.minwidth = Math.max(0, n + s + a));
							}
					...
					(e.prototype.handleSpeech = function () {
						...
						if (n) {
							var i = this.getTitleID(),
								a = this.svg("title", { id: i }, [this.text(n)]);
							r.insert(a, r.firstChild(this.element)),
								r.setAttribute(this.element, "aria-labeledby", i),
								r.removeAttribute(this.element, "aria-label");
							try {
								for (
									var l = s(this.childNodes[0].childNodes), h = l.next();
									!h.done;
									h = l.next()
								) {
									var c = h.value;
									r.setAttribute(c.element, "aria-hidden", "true");
								}
							} catch (e) {
								t = { error: e };
							} finally {
					...
					(e.kind = h.MmlMath.prototype.kind),
					(e.styles = {
			...
			})(l.CommonMathMixin(a.SVGWrapper));
		e.SVGmath = u;
	},
	function (t, e, r) {
		"use strict";
		...
		var i = r(0),
			...
			})(s.CommonMrowMixin(i.SVGWrapper));
		e.SVGmrow = h;
		var c = (function (t) {
			function e() {
				return (null !== t && t.apply(this, arguments)) || this;
	...
	function (t, e, r) {
		...
		var i = r(0),
			...
			l = (function (t) {
				...
				return n(e, t), (e.kind = a.MmlMi.prototype.kind), e;
			})(s.CommonMiMixin(i.SVGWrapper));
		e.SVGmi = l;
	},
	function (t, e, r) {
		"use strict";
		...
		var s = r(0),
			...
			c = (function (t) {
				...
				return (
					...
					(e.prototype.toSVG = function (e) {
						var r = this.node.attributes,
							o = r.get("symmetric") && 2 !== this.stretch.dir,
							n = 0 !== this.stretch.dir;
						n && null === this.size && this.getStretchedVariant([]);
						var i = this.standardSVGnode(e);
						if (n && this.size < 0) this.stretchSVG();
						else {
							if (o || r.get("largeop")) {
								var s = h.BBox.empty();
								t.prototype.computeBBox.call(this, s);
								var a = this.fixed(
									(s.d - s.h) / 2 + this.font.params.axis_height,
								);
								"0" !== a &&
					...
					(e.prototype.stretchSVG = function () {
						var t = this.stretch.stretch,
							e = this.getBBox();
						1 === this.stretch.dir
							? this.stretchVertical(t, e)
							: this.stretchHorizontal(t, e);
					}),
					(e.prototype.stretchVertical = function (t, e) {
						var r = e.h,
							o = e.d,
							n = e.w,
							s = this.addTop(t[0], r, n),
							a = this.addBot(t[2], o, n);
						if (4 === t.length) {
							var l = i(this.addMidV(t[3], n), 2),
								h = l[0],
								c = l[1];
							this.addExtV(t[1], r, 0, s, h, n),
								this.addExtV(t[1], 0, o, c, a, n);
						} else this.addExtV(t[1], r, o, s, a, n);
					}),
					(e.prototype.stretchHorizontal = function (t, e) {
						var r = e.w,
							o = this.addLeft(t[0]),
							n = this.addRight(t[2], r);
						if (4 === t.length) {
							var s = i(this.addMidH(t[3], r), 2),
								a = s[0],
								l = s[1],
								h = r / 2;
							this.addExtH(t[1], h, o, h - a),
								this.addExtH(t[1], h, l - h, n, h);
						} else this.addExtH(t[1], r, o, n);
					}),
					(e.prototype.getChar = function (t) {
						var e = this.font.getChar("-size4", t) || [0, 0, 0, null];
						return [e[0], e[1], e[2], e[3] || {}];
					}),
					(e.prototype.addGlyph = function (t, e, r, o) {
						return (
							void 0 === o && (o = null),
							this.placeChar(t, e, r, o || this.element, "-size4")
						);
					}),
					(e.prototype.addTop = function (t, e, r) {
						if (!t) return 0;
						var o = i(this.getChar(t), 3),
							n = o[0],
							s = o[1],
							a = o[2];
						return this.addGlyph(t, (r - a) / 2, e - n), n + s;
					}),
					(e.prototype.addExtV = function (t, e, r, o, n, s) {
						var a = this;
						if (t) {
							(o = Math.max(0, o - 0.1)), (n = Math.max(0, n - 0.1));
							var l = this.adaptor,
								h = i(this.getChar(t), 3),
								c = h[0],
								u = h[1],
								p = h[2],
								d = e + r - o - n,
							...
							if (!(d <= 0)) {
								...
								this.addGlyph(t, 0, 0, m);
								var v = l.lastChild(m);
								l.setAttribute(
									v,
									"transform",
									"scale(1, " + this.jax.fixed(f) + ")",
								),
									l.append(this.element, m);
							}
						}
					}),
					(e.prototype.addBot = function (t, e, r) {
						if (!t) return 0;
						var o = i(this.getChar(t), 3),
							n = o[0],
							s = o[1],
							a = o[2];
						return this.addGlyph(t, (r - a) / 2, s - e), n + s;
					}),
					(e.prototype.addMidV = function (t, e) {
						if (!t) return [0, 0];
						var r = i(this.getChar(t), 3),
							o = r[0],
							n = r[1],
							s = r[2],
							a = (n - o) / 2 + this.font.params.axis_height;
						return this.addGlyph(t, (e - s) / 2, a), [o + a, n - a];
					}),
					(e.prototype.addLeft = function (t) {
						return t ? this.addGlyph(t, 0, 0) : 0;
					}),
					(e.prototype.addExtH = function (t, e, r, o, n) {
						var s = this;
						if ((void 0 === n && (n = 0), t)) {
							(o = Math.max(0, o - 0.1)), (r = Math.max(0, r - 0.1));
							var a = i(this.getChar(t), 3),
								l = a[0],
								h = a[1],
								c = a[2],
								u = e - r - o,
							...
							if (!(u <= 0)) {
								...
								var m = this.adaptor.lastChild(y);
								this.adaptor.setAttribute(
									m,
									"transform",
									"scale(" + this.jax.fixed(d) + ", 1)",
								),
									this.adaptor.append(this.element, y);
							}
						}
					}),
					(e.prototype.addRight = function (t, e) {
						if (!t) return 0;
						var r = this.getChar(t)[2];
						return this.addGlyph(t, e - r, 0);
					}),
					(e.prototype.addMidH = function (t, e) {
						if (!t) return [0, 0];
						var r = this.getChar(t)[2];
						return this.addGlyph(t, (e - r) / 2, 0), [(e - r) / 2, (e + r) / 2];
					}),
					(e.kind = l.MmlMo.prototype.kind),
					e
				);
			})(a.CommonMoMixin(s.SVGWrapper));
		e.SVGmo = c;
	},
	function (t, e, r) {
		"use strict";
		...
		var i = r(0),
			...
			l = (function (t) {
				...
				return n(e, t), (e.kind = a.MmlMn.prototype.kind), e;
			})(s.CommonMnMixin(i.SVGWrapper));
		e.SVGmn = l;
	},
	function (t, e, r) {
		"use strict";
		...
		var i = r(0),
			...
			l = (function (t) {
				...
				return n(e, t), (e.kind = a.MmlMs.prototype.kind), e;
			})(s.CommonMsMixin(i.SVGWrapper));
		e.SVGms = l;
	},
	function (t, e, r) {
		"use strict";
		...
		var i = r(0),
			...
			l = (function (t) {
				...
				return n(e, t), (e.kind = a.MmlMtext.prototype.kind), e;
			})(s.CommonMtextMixin(i.SVGWrapper));
		e.SVGmtext = l;
	},
	function (t, e, r) {
		"use strict";
			...
			a = (function (t) {
				...
				return (
					...
					(e.prototype.toSVG = function (t) {
						...
						var s = this.node.attributes.get("title");
						s &&
							this.adaptor.append(
								this.element,
								this.svg("title", {}, [this.adaptor.text(s)]),
							),
							this.addChildren(e);
					}),
					(e.kind = s.MmlMerror.prototype.kind),
					(e.styles = {
	...
	function (t, e, r) {
		...
		var i = r(0),
			...
			l = (function (t) {
				...
				return n(e, t), (e.kind = a.MmlMspace.prototype.kind), e;
			})(s.CommonMspaceMixin(i.SVGWrapper));
		e.SVGmspace = l;
	},
	function (t, e, r) {
		"use strict";
		...
		var s = r(0),
			...
			})(a.CommonMpaddedMixin(s.SVGWrapper));
		e.SVGmpadded = h;
	},
	function (t, e, r) {
		"use strict";
		...
		var i = r(0),
			...
			a = (function (t) {
				...
				return (
					...
					(e.kind = s.MmlMphantom.prototype.kind),
					e
				);
			})(i.SVGWrapper);
		e.SVGmphantom = a;
				...
				return (
					...
					(e.prototype.makeFraction = function (t, e) {
						var r = this.element,
							...
							m = this.getAlignX(y, c, n) + 0.1 + f,
							v = this.getAlignX(y, u, s) + 0.1 + f,
							b = this.getTUV(t, e),
							x = b.T,
							g = b.u,
							_ = b.v;
						l.toSVG(r),
							l.place(m, d + x + Math.max(c.d * c.rscale, g)),
							h.toSVG(r),
							h.place(v, d - x - Math.max(u.h * u.rscale, _)),
							this.adaptor.append(
								r,
								this.svg("rect", {
					...
					(e.prototype.makeAtop = function (t) {
						var e = this.element,
							...
							f = this.getAlignX(d, h, o) + p,
							y = this.getAlignX(d, c, n) + p,
							m = this.getUVQ(t),
							v = m.u,
							b = m.v;
						a.toSVG(e), a.place(f, v), l.toSVG(e), l.place(y, -b);
					}),
					(e.prototype.makeBevelled = function (t) {
						var e = this.element,
							...
							o = r[0],
							n = r[1],
							s = this.getBevelData(t),
							a = s.u,
							l = s.v,
							h = s.delta,
							c = s.nbox,
							u = s.dbox,
							p = (c.L + c.w + c.R) * c.rscale;
						o.toSVG(e),
							this.bevel.toSVG(e),
							n.toSVG(e),
							o.place(c.L * c.rscale, a),
							this.bevel.place(p - h / 2, 0),
							n.place(p + this.bevel.getBBox().w + u.L * u.rscale - h, l);
					}),
					(e.kind = l.MmlMfrac.prototype.kind),
					e
				);
			})(a.CommonMfracMixin(s.SVGWrapper));
		e.SVGmfrac = h;
	},
	function (t, e, r) {
		"use strict";
				...
				return (
					...
					(e.prototype.addRoot = function (t, e, r, o) {
						...
						var n = i(this.getRootDimens(r, o), 3),
							...
							l = n[2],
							h = e.getBBox();
						e.place(l * h.rscale, a), (this.dx = s);
					}),
					(e.kind = l.MmlMroot.prototype.kind),
					e
				);
			})(a.CommonMrootMixin(s.SVGmsqrt));
		e.SVGmroot = h;
	},
	function (t, e, r) {
		"use strict";
		...
		var s = r(0),
			...
			})(a.CommonMfencedMixin(s.SVGWrapper));
		e.SVGmfenced = h;
	},
	function (t, e, r) {
		"use strict";
				...
				return (
					...
					(e.prototype.toSVG = function (t) {
						...
						this.baseChild.toSVG(e),
							this.script.toSVG(e),
							this.script.place(r.w * r.rscale + s, a);
					}),
					(e.kind = "scriptbase"),
					(e.useIC = !1),
					e
				);
			})(r(39).CommonScriptbaseMixin(s.SVGWrapper));
		e.SVGscriptbase = a;
	},
	function (t, e, r) {
		"use strict";
					...
					(e.prototype.toSVG = function (e) {
						if (this.hasMovableLimits()) t.prototype.toSVG.call(this, e);
							...
							var r = this.standardSVGnode(e),
								o = i([this.baseChild, this.script], 2),
								n = o[0],
								s = o[1],
								a = i([n.getBBox(), s.getBBox()], 2),
								l = a[0],
								h = a[1];
							n.toSVG(r), s.toSVG(r);
							var c = this.getDelta(!0),
								u = this.getUnderKV(l, h)[1],
								p = i(this.getDeltaW([l, h], [0, -c]), 2),
								d = p[0],
								f = p[1];
							n.place(d, 0), s.place(f, u);
						}
					}),
				...
				(e.prototype.toSVG = function (e) {
					if (this.hasMovableLimits()) t.prototype.toSVG.call(this, e);
						...
						var r = this.standardSVGnode(e),
							...
							s = o[1],
							a = o[2],
							l = i([n.getBBox(), s.getBBox(), a.getBBox()], 3),
							h = l[0],
							c = l[1],
							u = l[2];
						n.toSVG(r), a.toSVG(r), s.toSVG(r);
						var p = this.getDelta(),
							d = this.getOverKU(h, c)[1],
							f = this.getUnderKV(h, u)[1],
							y = i(this.getDeltaW([h, u, c], [0, -p, p]), 3),
							m = y[0],
							v = y[1],
							b = y[2];
						n.place(m, 0), a.place(v, f), s.place(b, d);
					}
				}),
		...
		})(h.CommonMunderoverMixin(s.SVGmsubsup));
		e.SVGmunderover = d;
	},
	function (t, e, r) {
		"use strict";
		...
		var s = r(8),
			...
			h = (function (t) {
				...
				return (
					...
					(e.prototype.toSVG = function (t) {
						...
						var c = this.baseChild;
						c.toSVG(e),
							c.place(h, 0),
							(h += c.getBBox().w),
							r.numScripts && this.addScripts(h, a, l, !1, 1, r.numScripts);
					}),
					(e.prototype.addScripts = function (t, e, r, o, n, s) {
						var a = this.adaptor,
							l = a.append(this.element, this.svg("g")),
							h = a.append(this.element, this.svg("g"));
						this.place(t, e, l), this.place(t, r, h);
						for (var c = n + 2 * s, u = 0; n < c; ) {
							var p = i([this.childNodes[n++], this.childNodes[n++]], 2),
								...
								m = y[0],
								v = y[1],
								b = i([m.rscale, v.rscale], 2),
								x = b[0],
								g = b[1],
								_ = Math.max(m.w * x, v.w * g);
							d.toSVG(h),
								f.toSVG(l),
								d.place(u + (o ? _ - m.w * x : 0), 0),
								f.place(u + (o ? _ - v.w * g : 0), 0),
								(u += _);
						}
						return t + u;
					}),
			...
			})(a.CommonMmultiscriptsMixin(s.SVGmsubsup));
	...
	function (t, e, r) {
		...
		var a = r(0),
			...
			c = (function (t) {
				...
				return (
					...
					(e.prototype.placeRows = function (t) {
						for (
							var e,
								...
								l = a.H,
								h = a.D,
								c = this.getEqualRowHeight(),
								u = this.getRowHalfSpacing(),
								p = s([this.fLine], this.rLines, [this.fLine]),
							...
							(e = i(this.getRowHD(n, c, l[f], h[f]), 2)),
								(y.H = e[0]),
								(y.D = e[1]),
								(r = i([u[f], u[f + 1]], 2)),
								(y.tSpace = r[0]),
					...
					(e.prototype.handleColor = function () {
						...
						var e = this.adaptor.firstChild(this.element);
						e &&
							this.adaptor.setAttribute(
								e,
								"width",
						...
						if ("none" !== this.node.attributes.get("columnlines")) {
							...
							if (e)
								for (
									...
									(i += r[s] + n[s] + r[s + 1]),
										"none" !== e[s] &&
											this.adaptor.append(t, this.makeVLine(i, e[s], o[s])),
										(i += o[s]);
						}
					}),
							...
							if (e)
								for (
									var r = this.node.attributes.get("equalrows"),
										...
										l = this.getRowHalfSpacing(),
										h = this.rLines,
										c = this.getBBox().h - this.fLine,
										u = 0;
									u < e.length;
									u++
								) {
									var p = i(this.getRowHD(r, a, n[u], s[u]), 2),
										d = p[0],
										f = p[1];
									(c -= l[u] + d + f + l[u + 1]),
										"none" !== e[u] &&
											this.adaptor.append(t, this.makeHLine(c, e[u], h[u])),
										(c -= h[u]);
								}
						}
					}),
					...
					(e.prototype.handlePWidth = function (t) {
						...
						var e = this.getBBox(),
							...
							a =
								...
								o -
								n,
							l = r - (this.pWidth > a ? a : this.pWidth),
							h = "left" === s ? 0 : "right" === s ? l : l / 2;
						if (h) {
							var c = this.svg("g", {}, this.adaptor.childNodes(t));
							this.place(h, 0, c), this.adaptor.append(t, c);
						}
						return h;
					}),
					...
					(e.prototype.handleLabels = function (t, e, r) {
						if (this.hasLabels) {
							...
							this.spaceLabels(),
								this.isTop ? this.topTable(t, o, n) : this.subTable(t, o, n, r);
						}
					}),
						...
						for (
							...
							if (a.node.isKind("mlabeledtr")) {
								...
								(n -= o[s] + a.H),
									...
									(n -= a.D + o[s + 1] + this.rLines[s]),
									(i = t.next(i));
							} else n -= o[s] + a.H + a.D + o[s + 1] + this.rLines[s];
						}
					}),
					(e.prototype.topTable = function (t, e, r) {
						var o = this.adaptor,
							...
							f = d[1],
							y = d[2] + ("right" === f ? -u : "center" === f ? -u / 2 : 0) + h,
							...
							v =
								...
								")",
							b = "translate(0 " + this.fixed(s) + ") " + m + " " + v,
							x = this.svg(
								"svg",
								{
									"data-table": !0,
						...
						(e = this.svg(
							...
							o.append(t, this.svg("g", { transform: b }, [x, e])),
							this.place(-h, 0, t);
					}),
					(e.prototype.subTable = function (t, e, r, o) {
						var n = this.adaptor,
							...
							p = Math.max(h, this.container.getWrapWidth(this.containerI));
						this.place(
							"left" === r
								? ("left" === u
										? 0
			...
			})(l.CommonMtableMixin(a.SVGWrapper));
		e.SVGmtable = c;
	},
	function (t, e, r) {
		"use strict";
				...
				return (
					...
					(e.prototype.placeCells = function (t) {
						for (
							var e = this.parent.getColumnHalfSpacing(),
								r = s([this.parent.fLine], this.parent.cLines, [
									this.parent.fLine,
								]),
					...
					(e.prototype.placeCell = function (t, e) {
						var r = e.x,
							...
							l = e.lLine,
							h = e.rLine,
							c = i(t.placeCell(r + n, o, s, this.H, this.D), 2),
							u = c[0],
							p = c[1],
							d = n + s + a,
							f = i([this.H + this.tSpace, this.D + this.bSpace], 2),
							y = f[0],
							m = f[1];
						return (
							t.placeColor(
					...
					(e.prototype.placeColor = function () {
						...
						if (
							e &&
							"rect" === t.kind(e) &&
							t.getAttribute(e, "data-bgcolor")
						) {
							var r = i([this.tLine / 2, this.bLine / 2], 2),
								o = r[0],
								n = r[1],
								s = i([this.tSpace, this.bSpace], 2),
								a = s[0],
								l = s[1],
								h = i([this.H, this.D], 2),
								c = h[0],
								u = h[1];
							t.setAttribute(e, "y", this.fixed(-(u + l + n))),
								t.setAttribute(e, "width", this.fixed(this.parent.getWidth())),
								t.setAttribute(e, "height", this.fixed(o + a + c + u + l + n));
						}
					}),
					(e.kind = c.MmlMtr.prototype.kind),
					e
				);
			})(l.CommonMtrMixin(a.SVGWrapper));
		e.SVGmtr = u;
		var p = (function (t) {
			function e() {
				return (null !== t && t.apply(this, arguments)) || this;
				...
				return (
					...
					(e.prototype.placeCell = function (t, e, r, o, n) {
						var i = this.getBBox(),
							...
							c = this.getAlignX(r, i, l),
							u = this.getAlignY(o, n, s, a, h);
						return this.place(t + c, e + u), [c, u];
					}),
					(e.prototype.placeColor = function (t, e, r, o) {
						var n = this.adaptor,
							i = n.firstChild(this.element);
						i &&
							"rect" === n.kind(i) &&
	...
	function (t, e, r) {
		...
		var i = r(0),
						...
						[
							...
							[
								function (t, e) {
									...
									if (r) {
										var o = t.adaptor.firstChild(t.element);
										if (r.node.isKind("mtext")) {
											...
											t.jax.processMath(a, i.firstChild(l)),
														...
														e.hoverTimer.set(
															...
															setTimeout(function () {
																...
																var e = i.nodeBBox(l),
																	...
																	n =
																		(r.bottom - e.bottom) / t.metrics.em + t.dy;
			...
			})(s.CommonMactionMixin(i.SVGWrapper));
		e.SVGmaction = h;
	},
	function (t, e, r) {
		"use strict";
		...
		var a = r(0),
				...
				return (
					...
					(e.prototype.toSVG = function (t) {
						var e,
							...
							s = {};
						n > 0 && (s.transform = "translate(" + this.fixed(n) + ", 0)");
						var a = this.adaptor.append(o, this.svg("g", s));
						this.renderChild
							? this.renderChild(this, a)
							: this.childNodes[0].toSVG(a);
						try {
							for (
								var l = i(Object.keys(this.notations)), h = l.next();
								!h.done;
								h = l.next()
							) {
								var c = h.value,
					...
					(e.prototype.arrow = function (t, e, r) {
						...
						if (e) {
							var y = this.jax.fixed((180 * -e) / Math.PI);
							this.adaptor.setAttribute(
								f,
								"transform",
								"rotate(" +
									[y, this.fixed(n / 2), this.fixed(a)].join(" ") +
									")",
							);
						}
						return f;
					...
					(e.notations = new Map([
						...
						h.DiagonalStrike("up"),
						h.DiagonalStrike("down"),
						[
							"horizontalstrike",
							{
								renderer: h.RenderLine("horizontal"),
								bbox: function (t) {
						...
						[
							"verticalstrike",
							{
								renderer: h.RenderLine("vertical"),
								bbox: function (t) {
						...
						[
							"roundedbox",
							{
								renderer: function (t, e) {
									...
									t.adaptor.append(t.element, t.box(o, n, i, s));
								},
								bbox: h.fullBBox,
							},
						],
							...
							"phasorangle",
							{
								renderer: function (t, e) {
									var r = t.getBBox(),
										...
										n = r.h,
										i = r.d,
										s = t.getArgMod(1.75 * t.padding, n + i)[0],
										a = t.thickness / 2,
										l = n + i,
										h = Math.cos(s);
									t.adaptor.append(
			...
			})(l.CommonMencloseMixin(a.SVGWrapper));
		e.SVGmenclose = u;
	},
	function (t, e, r) {
		"use strict";
		...
		n(r(5), e),
			...
			(e.lineData = function (t, r) {
				var o = t.getBBox(),
					n = o.h,
					i = o.d,
					s = o.w,
					a = t.thickness / 2;
				return e.computeLineData[r](n, i, s, a);
			}),
			(e.RenderLine = function (t) {
				return function (r, o) {
	...
	function (t, e, r) {
		...
		var i = r(0),
			...
			})(s.CommonSemanticsMixin(i.SVGWrapper));
		e.SVGsemantics = h;
		var c = (function (t) {
			function e() {
				return (null !== t && t.apply(this, arguments)) || this;
	...
	function (t, e, r) {
		...
		var i = r(0),
			...
			})(s.CommonMglyphMixin(i.SVGWrapper));
		e.SVGmglyph = l;
	},
	function (t, e, r) {
		"use strict";
		...
		var i = r(0),
			...
			})(s.CommonTeXAtomMixin(i.SVGWrapper));
		e.SVGTeXAtom = h;
	},
	function (t, e, r) {
		"use strict";
				...
				return (
					...
					(e.prototype.toSVG = function (t) {
						...
						if ("-explicitFont" === n)
							...
							var s = this.remappedText(o, n),
								a = 0;
							try {
								for (var l = i(s), h = l.next(); !h.done; h = l.next()) {
									var c = h.value;
									a += this.placeChar(c, a, 0, t, n);
								}
							} catch (t) {
								e = { error: t };
							} finally {
					...
					(e.styles = { ".MathJax path": { "stroke-width": 3 } }),
					e
				);
			})(r(21).CommonTextNodeMixin(a.SVGWrapper));
		e.SVGTextNode = l;
	},
	function (t, e, r) {
		"use strict";
	...
	function (t, e, r) {
		...
		Object(o.combineWithMathJax)({
			...
			MathJax.loader &&
				Object(o.combineDefaults)(MathJax.config.loader, "output/svg", {
					checkReady: function () {

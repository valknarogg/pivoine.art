!(function (c) {
	...
	function i(t) {
		...
		var e = (f[t] = { i: t, l: !1, exports: {} });
		return c[t].call(e.exports, e, e.exports, i), (e.l = !0), e.exports;
	}
	(i.m = c),
		(i.c = f),
		(i.d = function (c, f, t) {
			i.o(c, f) || Object.defineProperty(c, f, { enumerable: !0, get: t });
		}),
		(i.r = function (c) {
		...
		(i.t = function (c, f) {
			if ((1 & f && (c = i(c)), 8 & f)) return c;
			if (4 & f && "object" == typeof c && c && c.__esModule) return c;
	...
	function (c, f, i) {
		"use strict";
		Object.defineProperty(f, "__esModule", { value: !0 }),
			(f.isObject = MathJax._.components.global.isObject),
			(f.combineConfig = MathJax._.components.global.combineConfig),
			(f.combineDefaults = MathJax._.components.global.combineDefaults),
			(f.combineWithMathJax = MathJax._.components.global.combineWithMathJax),
			(f.MathJax = MathJax._.components.global.MathJax);
	},
	function (c, f, i) {
		"use strict";
		var t,
			e =
				...
				((t = function (c, f) {
					return (t =
						...
						function (c, f) {
							for (var i in f) f.hasOwnProperty(i) && (c[i] = f[i]);
						})(c, f);
				}),
				function (c, f) {
					function i() {
		...
		var r = i(0),
			...
			X = (function (c) {
				...
				return (
					...
					(f.defaultDelimiters = T.delimiters),
					(f.defaultChars = {
						normal: I.normal,
						bold: S.bold,
						italic: u.italic,
						...
						"-size3": D.texSize3,
						"-size4": v.texSize4,
						"-tex-calligraphic": H.texCalligraphic,
						"-tex-bold-calligraphic": b.texCalligraphicBold,
						"-tex-mathit": y.texMathit,
						"-tex-oldstyle": R.texOldstyle,
						"-tex-bold-oldstyle": E.texOldstyleBold,
						"-tex-variant": O.texVariant,
					}),
	...
	function (c, f, i) {
		...
		var e = { c: 47, dir: t.V, sizes: f.VSIZES },
			...
			r = { c: 710, dir: t.H, sizes: [0.517, 0.817, 1.335, 1.777, 1.909] },
			o = { c: 732, dir: t.H, sizes: [0.583, 0.805, 1.33, 1.773, 1.887] },
			a = {
				c: 8211,
				dir: t.H,
				sizes: [0.5],
			...
			d = { c: 8656, dir: t.H, sizes: [1], stretch: [8656, 61], HDW: f.HDW3 },
			k = {
				c: 8658,
				dir: t.H,
				sizes: [1],
			...
			_ = { c: 10216, dir: t.V, sizes: f.VSIZES },
			b = { c: 10217, dir: t.V, sizes: f.VSIZES },
			H = {
				c: 10502,
				dir: t.H,
		...
		f.delimiters = {
			...
			45: A,
			47: e,
			61: { dir: t.H, sizes: [0.767], stretch: [0, 61], HDW: f.HDW3 },
			91: {
				dir: t.V,
				sizes: f.VSIZES,
	...
	function (c, f, i) {
		"use strict";
		Object.defineProperty(f, "__esModule", { value: !0 }),
			(f.PackageError = MathJax._.components.package.PackageError),
			(f.Package = MathJax._.components.package.Package);
	},
	function (c, f, i) {
		"use strict";
		Object.defineProperty(f, "__esModule", { value: !0 }),
			(f.APPEND = MathJax._.util.Options.APPEND),
			(f.REMOVE = MathJax._.util.Options.REMOVE),
			(f.Expandable = MathJax._.util.Options.Expandable),
			(f.expandable = MathJax._.util.Options.expandable),
			(f.makeArray = MathJax._.util.Options.makeArray),
			(f.keys = MathJax._.util.Options.keys),
			(f.copy = MathJax._.util.Options.copy),
			(f.insert = MathJax._.util.Options.insert),
			(f.defaultOptions = MathJax._.util.Options.defaultOptions),
			(f.userOptions = MathJax._.util.Options.userOptions),
			(f.selectOptions = MathJax._.util.Options.selectOptions),
			(f.selectOptionsFromKeys = MathJax._.util.Options.selectOptionsFromKeys),
			(f.separateOptions = MathJax._.util.Options.separateOptions);
	},
	function (c, f, i) {
		"use strict";
		var t,
		...
		Object.defineProperty(f, "__esModule", { value: !0 }),
			...
			(f.CommonTeXFontMixin = function (c) {
				...
				return (
					...
					})(c)).defaultVariants = o(c.defaultVariants, [
						["-smallop", "normal"],
						["-largeop", "normal"],
						["-size3", "normal"],
						["-size4", "normal"],
					...
					(f.defaultCssFonts = s(s({}, c.defaultCssFonts), {
						"-smallop": ["serif", !1, !1],
						"-largeop": ["serif", !1, !1],
						"-size3": ["serif", !1, !1],
						"-size4": ["serif", !1, !1],
	...
	function (c, f, i) {
					...
					chtml: {
						fonts: {
							...
							tex: {
								...
								monospace: l,
								normal: B,
								"sans-serif-bold-italic": u,
								"sans-serif-bold": d,
								"sans-serif-italic": k,
								"sans-serif": I,
								smallop: A,
								"tex-calligraphic-bold": p,
								"tex-size3": m,
								"tex-size4": h,
								"tex-variant": M,
							},
		...
		var N = i(45),
			K = i(46);
		if (MathJax.startup) {
			Object(t.combineDefaults)(MathJax.config, "chtml", {
				fontURL: N.Package.resolvePath("output/chtml/fonts/woff-v2", !1),
			});
			var G = Object(K.selectOptionsFromKeys)(
				MathJax.config.chtml || {},
				e.TeXFont.OPTIONS,
			);
			Object(t.combineDefaults)(MathJax.config, "chtml", {
				font: new e.TeXFont(G),
			});
		}
	},
]);

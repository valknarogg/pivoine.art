					...
					if (u) {
						...
						switch (t.kind(u)) {
							case "html":
								...
								(e.root = u),
									t.remove(u),
									t.parent(e.body) !== u && t.append(u, e.body),
									t.parent(e.head) !== u && t.insert(e.head, e.body);
								break;
							case "head":
								e.head = t.replace(u, e.head);
								break;
							case "body":
								e.body = t.replace(u, e.body);
						}
					}
				}),

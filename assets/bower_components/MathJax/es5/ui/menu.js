!(function (t) {
	...
	function (t, e, n) {
		...
		(e.HtmlClasses = {
			...
			MENUACTIVE: i("MenuActive"),
			MENUCHECK: i("MenuCheck"),
			MENUCLOSE: i("MenuClose"),
			MENUCOMBOBOX: i("MenuComboBox"),
			MENUDISABLED: i("MenuDisabled"),
			MENUFRAME: i("MenuFrame"),
			MENUITEM: i("MenuItem"),
			MENULABEL: i("MenuLabel"),
			MENURADIOCHECK: i("MenuRadioCheck"),
			MENUINPUTBOX: i("MenuInputBox"),
			MENURULE: i("MenuRule"),
			MENUSLIDER: i("MenuSlider"),
			MOUSEPOST: i("MousePost"),
			RTL: i("RTL"),
			INFO: i("Info"),
			INFOCLOSE: i("InfoClose"),
			INFOCONTENT: i("InfoContent"),
			INFOSIGNATURE: i("InfoSignature"),
			INFOTITLE: i("InfoTitle"),
			SLIDERVALUE: i("SliderValue"),
			SLIDERBAR: i("SliderBar"),
			SELECTION: i("Selection"),
			SELECTIONBOX: i("SelectionBox"),
			SELECTIONMENU: i("SelectionMenu"),
			SELECTIONDIVIDER: i("SelectionDivider"),
			SELECTIONITEM: i("SelectionItem"),
		}),
			(e.HtmlAttrs = {
				COUNTER: r("Counter"),
				KEYDOWNFUNC: r("keydownFunc"),
				CONTEXTMENUFUNC: r("contextmenuFunc"),
				OLDTAB: r("Oldtabindex"),
				TOUCHFUNC: r("TouchFunc"),
			});
	},
	function (t, e, n) {
		"use strict";
			...
			l = (function (t) {
				...
				return (
					...
					(e.prototype.activate = function () {
						this.disabled || this.html.classList.add(u.HtmlClasses.MENUACTIVE);
					}),
				...
				((e = (function (t) {
					function e() {
						...
						return (
							...
							(o.options.MathItem = f(o.options.MathItem)),
							o
						);
					}
					return (
			...
			c = (function (t) {
				...
				return (
					...
					(e.prototype.generateMenu = function () {
						...
						try {
							for (var o = r(this.items), i = o.next(); !i.done; i = o.next()) {
								var s = i.value;
								if (s.isHidden()) {
									var a = s.html;
				...
				return (
					...
					(e.prototype.post = function () {
						...
						var e = document.documentElement,
							n = this.html,
							o = window.innerHeight || e.clientHeight || e.scrollHeight || 0,
					...
					(e.prototype.dynamicSubmenus = function () {
						...
						try {
							for (
								...
								if (c) {
									var p = l(this, c);
									(c.submenu = p), p.items.length ? c.enable() : c.disable();
								}
							}
						} catch (e) {
							t = { error: e };
			...
			b = (function () {
				function t(t, e) {
					...
					void 0 === e && (e = {}),
						...
						(this.rerenderStart = r.STATE.LAST),
						(this.about = new p.Info(
							'<b style="font-size:120%;">MathJax</b> v' + i.mathjax.version,
							function () {
								var t = [];
								return (
									t.push(
						...
						(this.mathmlCode = new c.SelectableInfo(
						...
						(this.originalText = new c.SelectableInfo(
						...
						(this.annotationText = new c.SelectableInfo(
				...
				return (
					...
					(t.prototype.initMenu = function () {
						var t = this,
							e = new h.Parser([
								["contextMenu", u.MJContextMenu.fromJson.bind(u.MJContextMenu)],
							]);
						this.menu = e.parse({
							type: "contextMenu",
							id: "MathJax_Menu",
					...
					(t.prototype.checkLoadableItems = function () {
						...
						if (m && m._ && m.loader && m.startup)
							...
							try {
								for (
									var i = o(Object.keys(this.jax)), r = i.next();
									!r.done;
									r = i.next()
								) {
									var s = r.value;
					...
					(t.prototype.enableExplorerItems = function (t) {
						var e,
							n,
							i = this.menu.findID("Accessibility", "Activate").menu;
						try {
							for (
								var r = o(i.items.slice(1)), s = r.next();
								!s.done;
								s = r.next()
							) {
								var a = s.value;
					...
					(t.prototype.saveUserSettings = function () {
						...
						try {
							for (
								var r = o(Object.keys(this.settings)), s = r.next();
								!s.done;
								s = r.next()
							) {
								var a = s.value;
						...
						try {
							Object.keys(i).length
								? localStorage.setItem(t.MENU_STORAGE, JSON.stringify(i))
					...
					(t.prototype.setCollapsible = function (t) {
						(this.document.options.enableComplexity = t),
							!t || (m._.a11y && m._.a11y.complexity)
								? this.rerender(r.STATE.COMPILED)
								: this.loadA11y("complexity");
					}),
					...
					(t.prototype.resetDefaults = function () {
						var e, n;
						t.loading++;
						var i = this.menu.pool,
							s = this.defaultSettings;
						try {
							for (
								var a = o(Object.keys(this.settings)), u = a.next();
								!u.done;
								u = a.next()
							) {
								var l = u.value,
					...
					(t.prototype.loadA11y = function (e) {
						...
						this.loadComponent("a11y/" + e, function () {
							var s = m.startup;
							i.mathjax.handlers.unregister(s.handler),
								(s.handler = s.getHandler()),
								i.mathjax.handlers.register(s.handler);
							var a = n.document;
							(n.document = s.document = s.getDocument()),
								(n.document.menu = n),
					...
					(t.prototype.transferMathList = function (t) {
						var e,
							n,
							i = this.document.options.MathItem;
						try {
							for (var r = o(t.math), s = r.next(); !s.done; s = r.next()) {
								var a = s.value,
									u = new i();
					...
					(t.prototype.a11yVar = function (t) {
						...
						return {
							...
							setter: function (n) {
								e.settings[t] = n;
								var o = {};
								(o[t] = n), e.setA11y(o), e.saveUserSettings();
							},
						};
					}),
					(t.prototype.submenu = function (t, e, n, i) {
						var r, s;
						void 0 === n && (n = []), void 0 === i && (i = !1);
						var a = [];
						try {
							for (var u = o(n), l = u.next(); !l.done; l = u.next()) {
								var c = l.value;
				...
				return (
					...
					(e.prototype.post = function (e, n) {
						...
						var o,
							...
							s = e;
						if (
							(s instanceof Event ? ((o = s.target), this.stop(s)) : (o = s),
		...
		var r = n(18),
			...
			a = (function (t) {
				function e(e) {
					...
					return (
						(n.className = s.HtmlClasses.MENUITEM), (n.role = "separator"), n
					);
				}
				return (
					i(e, t),
				...
				return (
					...
					(t.prototype.addTabindex = function (t) {
						t.hasAttribute("tabindex") &&
							t.setAttribute(r.HtmlAttrs.OLDTAB, t.getAttribute("tabindex")),
							t.setAttribute("tabindex", "0");
					}),
					(t.prototype.removeTabindex = function (t) {
						t.hasAttribute(r.HtmlAttrs.OLDTAB)
							? (t.setAttribute("tabindex", t.getAttribute(r.HtmlAttrs.OLDTAB)),
				...
				function t(t) {
					...
					void 0 === t && (t = []),
						(this._initList = [
							...
							["selectionMenu", v.SelectionMenu.fromJson.bind(v.SelectionMenu)],
							["selectionBox", v.SelectionBox.fromJson.bind(v.SelectionBox)],
						]),
				...
				return (
					...
					(e.fromJson = function (t, e, n) {
						var o = e.title,
							...
							u = t.get("rule")(t, {}, s),
							l = i.map(function (e) {
								return t.get("radio")(t, { content: e, variable: r, id: e }, s);
							}),
							c = [a, u].concat(l);
						return (s.items = c), s;
					}),
	...
	function (t, e, n) {
		...
		!(function (t) {
			...
			(i[e("MENU")] =
				...
				(i[e("MENUITEM")] = "{  padding: 1px 2em;  background:transparent;}"),
				(i[e("MENUARROW")] =
				...
				(i[e("MENUACTIVE")] = "{  background-color: #606872;  color: white;}"),
